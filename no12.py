...
global masterlolo,back_image,e1,variable,photo1,photo2

masterlolo= Tk()
masterlolo.resizable(width=False, height=False)
masterlolo.geometry('1370x745')

masterlolo.configure(background='red')

w1 = Label(masterlolo, text="Q4. FOUR(4) -SEVEN(7)=MINUS THREE(-3)?",fg="black",bg='yellow',font=("Comic Sans MS", 44))
...
submitbutton=Button(masterlolo,image=photo1,command=true)
submitbutton.grid(row=1,column=0,sticky=W,padx=(60,30))



submitbutton1=Button(masterlolo,image=photo2,command=false)
