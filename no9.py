...
global mastergo,back_image,e1,variable,photo1,photo2

mastergo= Tk()
mastergo.resizable(width=False, height=False)
mastergo.geometry('1370x745')

mastergo.configure(background='red')

w1 = Label(mastergo, text="Q1. FOUR (4) - THREE (3)=TWO(2)?",fg="black",bg='yellow',font=("Comic Sans MS", 44))
...
submitbutton=Button(mastergo,image=photo1,command=false)
submitbutton.grid(row=1,column=0,sticky=W,padx=(60,30))



submitbutton1=Button(mastergo,image=photo2,command=true)
