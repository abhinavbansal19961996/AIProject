...
global masterkat,back_image,e1,variable,photo1,photo2

masterkat= Tk()
masterkat.resizable(width=False, height=False)
masterkat.geometry('1370x745')

masterkat.configure(background='red')

w1 = Label(masterkat, text="Q6. IS 7= SEVEN?",fg="black",bg='yellow',font=("Comic Sans MS", 44))
...
submitbutton=Button(masterkat,image=photo1,command=true)
submitbutton.grid(row=1,column=0,sticky=W,padx=(60,30))



submitbutton1=Button(masterkat,image=photo2,command=false)
